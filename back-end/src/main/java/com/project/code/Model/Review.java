...
//    - This field cannot be empty, use the @NotNull annotation to enforce this rule.
    @NotNull(message = "Given rating cannot be null")
    @Min(0)
    @Max(5)
...
//    - The constructor should accept values for customerId, productId, storeId, rating, and an optional comment.
    ...
    public Review(@NotNull(message = "Customer cannot be null") Long customerId,
            ...
            @NotNull(message = "Given rating cannot be null") @Min(0) @Max(5) Integer rating) {
    ...
    public Review(@NotNull(message = "Customer cannot be null") Long customerId,
            @NotNull(message = "Product cannot be null") Long productId,
            @NotNull(message = "Store cannot be null") Long storeId,
            @NotNull(message = "Given rating cannot be null") @Min(0) @Max(5) Integer rating, String comment) {
        this.customerId = customerId;
        this.productId = productId;
        this.storeId = storeId;
        this.rating = rating;
